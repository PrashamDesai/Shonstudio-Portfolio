export const projects = [
  {
    ...
    description:
      "Aurora Drift is a premium indie concept where environment storytelling, polished traversal, and cinematic mood work together to create a clear identity for launch and investor conversations.",
    ...
    roleBreakdown: [
      {
        ...
        summary: "Framed the visual north star, pitch narrative, and progression tone."
      },
      {
        title: "Gameplay Systems",
        summary: "Defined movement feel, interaction rhythm, and environmental guidance."
      },
      {
        title: "Production Strategy",
        summary: "Packaged the concept into milestone-ready slices with practical delivery scope."
      }
    ],
    featured: true
  },
  {
    ...
    description:
      "A tactics-led production sample focused on combat readability, mission drama, and a launch-friendly content pipeline for updates and live balancing.",
    ...
    roleBreakdown: [
      {
        ...
        summary: "Built pacing rules, balancing logic, and content update structure."
      },
      {
        title: "UX Direction",
        summary: "Delivered a tactical HUD that stayed cinematic without losing player clarity."
      },
      {
        title: "QA Planning",
        summary: "Mapped risk-heavy gameplay scenarios and regression checkpoints."
      }
    ],
    featured: true
  },
  {
    ...
    description:
      "Pulse XR Lab shows how the studio approaches immersive instruction, comfort-first interaction, and stakeholder-friendly prototyping for teaching or simulation products.",
    ...
    roleBreakdown: [
      {
        ...
        summary: "Structured interactions for comfort, clarity, and future iteration."
      },
      {
        title: "Learning Experience",
        summary: "Wove guided prompts and measurable tasks into the immersion loop."
      },
      {
        title: "Client Communication",
        summary: "Prepared review-ready assets for roadmap decisions and pilot signoff."
      }
    ],
    featured: false
  }
...
export const services = [
  {
    ...
    slug: "unity-2d-games",
    summary: "Responsive 2D production with strong feel, clean visual storytelling, and efficient content pipelines.",
    description:
      "We build 2D titles that feel refined in motion, easy to onboard into, and practical to maintain as content grows.",
    category: "Game Development",
    icon: "grid",
    highlights: ["Rapid prototyping", "Level design support", "Performance-aware builds"],
    deliveryFormat: "Prototype to production",
    featured: true
  },
  {
    title: "2.5D Games",
    slug: "2-5d-games",
    summary: "Cinematic depth with a disciplined approach to readability and scope.",
    description:
      "Ideal for teams that want a premium visual edge without compromising play clarity or pipeline control.",
    category: "Game Development",
    icon: "layers",
    highlights: ["Hybrid pipelines", "Stylized environments", "Camera-led storytelling"],
    deliveryFormat: "Vertical slice or expansion",
    featured: true
  },
  {
    title: "3D Games",
    slug: "3d-games",
    summary: "3D production shaped around modularity, feel, and launch readiness.",
    description:
      "We help teams turn ambitious 3D ideas into polished production plans that respect scope and player experience.",
    category: "Game Development",
    icon: "cube",
  ...
  },
  {
    title: "XR Games",
    slug: "xr-games",
    summary: "Immersive products for experiential, training, and educational goals.",
    description:
      "We design comfort-first XR interactions that work for demos, pilots, and measurable learning outcomes.",
    category: "Immersive",
    icon: "orbit",
  ...
  },
  {
    ...
    summary: "Interactive learning modules with clear structure and meaningful outcomes.",
    description:
      "Curriculum-led modules that combine clarity, engagement, and real production relevance.",
    category: "Education",
    icon: "book",
  ...
  },
  {
    title: "QA Testing",
    slug: "qa-testing",
    summary: "Testing support focused on stability, clarity, and release confidence.",
    description:
      "From exploratory passes to structured regression planning, we help reduce avoidable launch risk.",
    category: "Support",
    icon: "shield",
  ...
  },
  {
    ...
    summary: "Audio direction and production aligned to gameplay rhythm and mood.",
    description:
      "We shape sound systems that support interaction feedback and world-building without excess noise.",
    category: "Audio",
    icon: "wave",
  ...
  },
  {
    ...
    summary: "Campaign assets and launch visuals with a premium studio tone.",
    description:
      "Promotional material that feels aligned with the product rather than disconnected from it.",
    category: "Marketing",
    icon: "spark",
...
export const tools = [
  {
    ...
    useCase: "Accelerates prototyping and keeps environment art direction consistent across milestones.",
  ...
  },
  {
    ...
    description:
      "Internal narrative flow tooling for branching conversations, player prompts, and event gating.",
    useCase: "Reduces engineering friction when prototyping narrative systems and teaching interactions.",
  ...
  },
  {
    ...
    useCase: "Speeds up alignment between creative direction, sound design, and client reviews.",
    tags: ["Audio", "Reference", "Production"]
  }
];

export const counsellingSteps = [
  {
    step: "01",
...
export const studioStats = [
  { value: "12+", label: "Prototype tracks shaped" },
  { value: "08", label: "Service lanes available" },
  { value: "4x", label: "Faster concept packaging" }
];
